...
const headCells = [
  ...
  {
    id: "isMeasureUsedInVisual",
    numeric: false,
    disablePadding: true,
    label: "isMeasureUsedInVisual",
  },
  {
    id: "PageName",
    numeric: false,
          ...
          >
            ...
            <TableBody>
              {rows.map((row, index) => {
                ...
                return (
                  <Tablerow row = {row} handleClick={handleClick} isItemSelected={isItemSelected} labelId = {labelId} thresholdValue = {thresholdValue}  />
                );
              })}
              {emptyRows > 0 && (
                <TableRow
